  ...
  <body class="justify-center flex">
    ...
    >
      ...
      <div class="lh-1 text-center mt-4">
        ...
        <!-- ganti pertanyaan -->
        <p class="title question fs-1 text-2xl font-bold text-gray-700">Mau Ngedate bersama ku tidak</p>
      </div>
      ...
      <div class="numbers hidden mt-5 flex justify-center">
        <!-- ganti link -->
        <a
          href="https://www.google.com/maps/place/Medan,+Kota+Medan,+Sumatera+Utara/@3.6426141,98.5046747,11z/data=!3m1!4b1!4m6!3m5!1s0x303131cc1c3eb2fd:0x23d431c8a6908262!8m2!3d3.5951956!4d98.6722227!16zL20vMDFfZF9u?entry=ttu&g_ep=EgoyMDI2MDExMy4wIKXMDSoASAFQAw%3D%3D"
          type="button"
          class="bg-green-500 text-white py-1 px-2 rounded btn-yes w-100 text-xl font-bold"
        >
          <!-- ganti tulisan tombol link -->
          langsung siap siap nihh</a
        >
      </div>
    </main>
    ...
    <script>
      ...
      function generateMessage(count) {
        const messages = ["no", "hmm?", "yakin?", "jarang jarang loh kesini","yeayyy", "klik yes ga bisa klik merah lagi wlee", "<--"];
